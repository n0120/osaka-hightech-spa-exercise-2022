const PrefectureSelector = {
  props: [
    ...
    'default-prefecture', // 初期設定した都道府県の変更を行う関数
  ],
  ...
  data() {
    return {
      ...
      defaultprefecture: "大阪府", // 初期設定する都道府県
      defaultprefectureindex: 0, // 初期設定する都道府県のインデックス # 使ってない
    };
  },
  ...
  <span v-for="(prefecture, index) in prefectures">
    ...
    <input
      ...
      v-on:change="onChange($event, index)"
      name="prefecture"
      v-bind:checked="defaultprefecture === prefecture"
    >
